...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AIzaSyDAWNLo_Rkiei5lxj3NjQWisVsEYFcfcwI";
    ...
    public FcmNotificationBuilder read(boolean isread) {
        mRead = isread;
        return this;
    }

    public FcmNotificationBuilder sender(String senderId) {
        mSenderId = senderId;
        return this;
    }
    ...
    private JSONObject getValidJsonBody() throws JSONException {
        ...
        jsonObjectBody.put(KEY_TO, "/topics/topic_" + mTopic);

        JSONObject jsonObjectData = new JSONObject();
        jsonObjectData.put(KEY_TITLE, mTitle);
        jsonObjectData.put(KEY_TEXT, mMessage);
        jsonObjectData.put(KEY_TIME, mTime);
        jsonObjectData.put(KEY_SENDER_ID, mSenderId);
        jsonObjectData.put(KEY_READ, false);
